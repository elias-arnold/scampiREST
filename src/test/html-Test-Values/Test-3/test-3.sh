...
echo -e "\nupload a index zip"
curl -v -F name="Hamlet-1.jpeg" -F key="picture" -F id="$myid" -F file=@"./Hamlet-1.jpeg.zip" http://myliberouter.org/dyn/upload
echo -e "\nupload sucessfull"

echo -e "\nupload a index zip"
curl -v -F name="Emilio-1.jpeg" -F key="picture2" -F id="$myid" -F file=@"./Emilio-1.jpeg.zip" http://myliberouter.org/dyn/upload
echo -e "\nupload sucessfull"
